    ...
    <main class="main">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4 justify-content-center">
                    ...
                    <div class="col-lg-8 content">
                        ...
                        <p class="fst-italic py-3">Get to know me with these personal details:</p>
                        <div class="row">
                            <div class="col-lg-6">
                                <ul>
                        ...
                        <p class="py-3">
                            <?php $result = $conn->query("SELECT additional_content FROM about LIMIT 1");
                            echo $result->fetch_assoc()['additional_content']; ?>
                        </p>
                    </div>
                </div>
        ...
        <section id="stats" class="stats section">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editPersonalStatsModal">Edit</button>
            </div><!-- End Section Title -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <ul class="tech-skills-list">
                        <?php
                        $result = $conn->query("SELECT * FROM technical_skills");
                        $skills = $result->fetch_all(MYSQLI_ASSOC);
                        $total = count($skills);
                        $half = ceil($total / 2);
                        for ($i = 0; $i < $half; $i++) {
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        ...
                        while ($row = $result->fetch_assoc()) { ?>
                            <div class="resume-item">
                                ...
                                <ul>
                                    <?php $bullets = explode("\n", $row['description']); // Split by newline for bullets
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="skillsForm">
                        ...
                        <!-- In #editSkillsModal (Technical Skills) -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="transferableSkillsForm">
                        ...
                        <!-- In #editTransferableSkillsModal (Transferable Skills) -->
